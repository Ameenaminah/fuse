...
export const BootCampsSection: FC<Props> = ({ items, title }) => (
  <section className="flex flex-col justify-between gap-5 lg:gap-10 font-dmSans">
    <p className="text-xl md:text-3xl font-semibold text-grey12 text-center">{title}</p>
